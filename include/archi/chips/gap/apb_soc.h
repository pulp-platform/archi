...
#ifndef __ARCHI_CHIPS_GAP_APB_SOC_H__
#define __ARCHI_CHIPS_GAP_APB_SOC_H__
...
#define APB_SOC_BOOT_SPI      1
#define APB_SOC_BOOT_JTAG     2
...
#define	APB_SOC_PADFUN0_OFFSET	  0x140
