...
#ifndef __ARCHI_CHIPS_VIVOSOC2_1_MEMORY_MAP_H__
#define __ARCHI_CHIPS_VIVOSOC2_1_MEMORY_MAP_H__
...
#define ARCHI_MCHAN_DEMUX_OFFSET      0x00000400

#define ARCHI_MCHAN_ADDR              ( ARCHI_DEMUX_ADDR + ARCHI_MCHAN_DEMUX_OFFSET )
