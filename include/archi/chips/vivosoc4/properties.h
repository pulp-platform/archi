...
#define ARCHI_UDMA_TIMESYNC_TMAO_ID 7
#define ARCHI_UDMA_TIMESYNC_EXG_ID  8
#define ARCHI_UDMA_TIMESYNC_MIUR_ID 9
...
#define ARCHI_SOC_EVENT_UDMA_NB_EVT                 32 //(ARCHI_SOC_EVENT_UDMA_NB_CHANNEL_EVT * ARCHI_NB_PERIPH)
...
#define ARCHI_SOC_EVENT_ADC_BUFF(adc)   (ARCHI_SOC_EVENT_ADC_BIOZ_BUFF + (adc))
...
#define ARCHI_SOC_EVENT_TIMESYNC_TMAO   64
#define ARCHI_SOC_EVENT_TIMESYNC_EXG    65
#define ARCHI_SOC_EVENT_TIMESYNC_MIUR   66

#define ARCHI_SOC_EVENT_THRESHOLD_TMAO  80
#define ARCHI_SOC_EVENT_THRESHOLD_EXG   81
#define ARCHI_SOC_EVENT_THRESHOLD_AUX   90
#define ARCHI_ADC_EXG_NUM_THR_CH        9
#define ARCHI_SOC_EVENT_THRESHOLD_ADC(id)   ((id == 3) ? ARCHI_SOC_EVENT_THRESHOLD_AUX : ((id == 2) ? ARCHI_SOC_EVENT_THRESHOLD_EXG : ARCHI_SOC_EVENT_THRESHOLD_TMAO))

#define ARCHI_ANALOG_PPG_NUM_THR_SETS   4

#define ARCHI_SOC_EVENT_ADV_TIMER0      72
#define ARCHI_SOC_EVENT_ADV_TIMER1      73
#define ARCHI_SOC_EVENT_ADV_TIMER2      74
#define ARCHI_SOC_EVENT_ADV_TIMER3      75
#define ARCHI_SOC_EVENT_ADV_TIMER(id)   (ARCHI_SOC_EVENT_ADV_TIMER0 + (id))

#define ARCHI_SOC_EVENT_GPIO            76
#define ARCHI_SOC_EVENT_PMIC            77
#define ARCHI_SOC_EVENT_VCC             78
#define ARCHI_SOC_EVENT_CL_PM           79

#define ARCHI_SOC_EVENT_TMAO_EOC        80
#define ARCHI_SOC_EVENT_MIUR_CURR_VLD   81
#define ARCHI_SOC_EVENT_MIUR_EOCA       82
#define ARCHI_SOC_EVENT_MIUR_EOCB       83

#define ARCHI_SOC_EVENT_FLL_CLUSTER     84
#define ARCHI_SOC_EVENT_FLL_SOC         85
#define ARCHI_SOC_EVENT_FLL_PERIPH      86
