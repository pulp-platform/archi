...
#define ARCHI_SOC_EVENT_HYPER_RX(id)    ARCHI_SOC_EVENT_UDMA_RX(ARCHI_UDMA_HYPER_ID(id))
#define ARCHI_SOC_EVENT_HYPER_TX(id)    ARCHI_SOC_EVENT_UDMA_TX(ARCHI_UDMA_HYPER_ID(id))
#endif
...
#define ARCHI_SOC_EVENT_UART_RX(id)    ARCHI_SOC_EVENT_UDMA_RX(ARCHI_UDMA_UART_ID(id))
#define ARCHI_SOC_EVENT_UART_TX(id)    ARCHI_SOC_EVENT_UDMA_TX(ARCHI_UDMA_UART_ID(id))
#endif
