...
#define PLP_TIMER_ENA                (1     << PLP_TIMER_ENABLE_BIT)
#define PLP_TIMER_DIS                (0     << PLP_TIMER_ENABLE_BIT)

#define PLP_TIMER_RESET_ENA          (1     << PLP_TIMER_RESET_BIT)
#define PLP_TIMER_RESET_DIS          (0     << PLP_TIMER_RESET_BIT)

#define PLP_TIMER_IRQ_ENA            (1     << PLP_TIMER_IRQ_ENABLE_BIT)
#define PLP_TIMER_IRQ_DIS            (0     << PLP_TIMER_IRQ_ENABLE_BIT)

#define PLP_TIMER_IEM_ENA            (1     << PLP_TIMER_IEM_BIT)
#define PLP_TIMER_IEM_DIS            (0     << PLP_TIMER_IEM_BIT)

#define PLP_TIMER_CMPCLR_ENA         (1     << PLP_TIMER_CMP_CLR_BIT)
#define PLP_TIMER_CMPCLR_DIS         (0     << PLP_TIMER_CMP_CLR_BIT)

#define PLP_TIMER_ONE_SHOT_ENA       (1     << PLP_TIMER_ONE_SHOT_BIT)
#define PLP_TIMER_ONE_SHOT_DIS       (0     << PLP_TIMER_ONE_SHOT_BIT)

#define PLP_TIMER_REFCLK_ENA         (1     << PLP_TIMER_CLOCK_SOURCE_BIT)
#define PLP_TIMER_REFCLK_DIS         (0     << PLP_TIMER_CLOCK_SOURCE_BIT)

#define PLP_TIMER_PRESCALER_ENA      (1     << PLP_TIMER_PRESCALER_ENABLE_BIT)
#define PLP_TIMER_PRESCALER_DIS      (0     << PLP_TIMER_PRESCALER_ENABLE_BIT)

#define PLP_TIMER_PRESCALER_VAL(val) ((val) << PLP_TIMER_PRESCALER_VALUE_BIT)

#define PLP_TIMER_MODE_64_ENA        (1     << PLP_TIMER_64_BIT)
#define PLP_TIMER_MODE_64_DIS        (0     << PLP_TIMER_64_BIT)
